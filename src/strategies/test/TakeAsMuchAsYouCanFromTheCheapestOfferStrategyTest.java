...
public class TakeAsMuchAsYouCanFromTheCheapestOfferStrategyTest {
	private static final String offerAgentName = "name";
	TakeAsMuchAsYouCanFromTheCheapestOfferStrategy ss = new TakeAsMuchAsYouCanFromTheCheapestOfferStrategy();
	...
	public void  test_composeFinalBuyingDecision_should_update_store_buy_and_have_map_correctly() {
		TakeAsMuchAsYouCanFromTheCheapestOfferStrategy strag = new TakeAsMuchAsYouCanFromTheCheapestOfferStrategy();
		double myMoney = 61;
